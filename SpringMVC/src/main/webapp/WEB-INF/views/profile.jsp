        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
               ...
               <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="profile"><i class="fas fa-user"></i><span>Register</span></a></li>
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>First Name</strong></label><input class="form-control" type="text" id="username" placeholder="First Name" name="firstname"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="email"><strong>Last Name</strong></label><input class="form-control" type="email" id="email" placeholder="Last Name" name="lastname"></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Mobile Number</strong></label><input class="form-control" type="text" id="first_name" placeholder="Mobile" name="mobile"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="last_name"><strong>Email</strong></label><input class="form-control" type="text" id="last_name" placeholder="example@mail.com" name="email"></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Date of Birth</strong></label><input class="form-control" type="date">
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="mb-3"><label class="form-label" for="first_name"><strong>Gender</strong></label>
                                                                        <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-2"><label class="form-check-label" for="formCheck-2">Male</label></div>
                                                                        <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-1"><label class="form-check-label" for="formCheck-1">Female</label></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Address</strong></label><textarea class="form-control" name="address" placeholder="address"></textarea></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name" style="font-size: 12px;"><strong>Emergency Contact Person Name</strong></label><input class="form-control" type="text" id="last_name-1" placeholder="Emergency Person" name="embp"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name" style="font-size: 12px;"><strong>Emergency Contact Person Mobile</strong></label><input class="form-control" type="text" id="last_name-2" placeholder="Emergency Person Mobile" name="embpm"></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Package</strong></label><select class="form-select">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Medical Condition</strong></label><textarea class="form-control" name="medical" placeholder="Medical Condition"></textarea></div>
                                                    </div>
                                                </div>
